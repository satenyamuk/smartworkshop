...
<div class="max-w-xl mx-auto">
    {{-- Back Link --}}
    <div class="mb-6">
        <a href="{{ route('admin.categories.index') }}" class="text-sm text-gray-500 hover:text-blue-600 flex items-center gap-1">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6 md:p-8 shadow-sm">
        <h1 class="text-xl font-bold text-gray-800 mb-2">Tambah Kategori Baru</h1>
        <p class="text-sm text-gray-500 mb-6">Buat kategori baru untuk mengelompokkan workshop.</p>
        ...
        <form method="POST" action="{{ route('admin.categories.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" placeholder="Contoh: Pemrograman Website, Desain UI/UX" required
